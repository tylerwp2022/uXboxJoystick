...
void showSynopsis()
{
  ...
  blk("  while backing.                                                ");
  blk("                                                                ");
  blk("  Flag grabbing under teleop is handled by the companion         ");
  blk("  VEHICLE-side app uAutoGrab (grab requests must originate in    ");
  blk("  the vehicle's own community to pass the flag manager's         ");
  blk("  anti-spoofing check; a shoreside requester cannot).            ");
  blk("                                                                ");
  blk("  Tagged boats remain fully controllable. Y / B dispatch the    ");
  blk("  left / right boat home to untag AUTONOMOUSLY (helm runs       ");
  blk("  waypt_untag under the REDIR gate); the app re-acquires the    ");
  blk("  instant the tag clears. Press again mid-return to reclaim.    ");
  blk("                                                                ");
...
void showExampleConfigAndExit()
{
  ...
  blk("  handback     = hold                                           ");
  blk("                                                                ");
  blk("  // hold mode only: on activation, REDIR-latch the WHOLE       ");
  blk("  // roster so unselected boats station-hold (do nothing)       ");
  blk("  // instead of playing. Tagged parked boats still auto-untag.  ");
  blk("  // Latch survives deactivation; release boats to game play    ");
  blk("  // via the pRedirectWaypoint b/r + w workflow.                ");
  blk("  park_unselected = true                                        ");
  blk("                                                                ");
  blk("                                                                ");
  ...
  blk("  // button_untag_left   = 3   // Y  (auto-untag left boat)      ");
  blk("  // button_untag_right  = 1   // B  (auto-untag right boat)     ");
...
void showInterfaceAndExit()
{
  ...
  blk("  VIEW_POINT                    (L / R stick-identity tag above ");
  blk("                                 each driven boat's ring;       ");
  blk("                                 HELM(L)/HELM(R) tag while      ");
  blk("                                 untag-dispatched; REV(L)/(R)   ");
  blk("                                 tag under an active brake bar) ");
  ...
  blk("                                 station_hold)                  ");
  blk("  XBOX_DRIVEN_<VNAME>           (hold only: true at acquire,    ");
  blk("                                 false at release. Mask trigger ");
  blk("                                 for the vehicle-side uGfxMask, ");
  blk("                                 which erases station_hold's    ");
  blk("                                 rings while the boat is stick- ");
  blk("                                 driven -- shoreside erases     ");
  blk("                                 cannot: pMarineViewer keys geo ");
  blk("                                 shapes per SOURCE community)   ");
  blk("  REDIR_HOLD_UPDATE_<VNAME>     (hold only: station_pt=x,y at   ");
  blk("                                 every release -- explicit re-  ");
  blk("                                 station, since center_activate ");
  blk("                                 sees no edge across override)  ");
  blk("                                                                ");
